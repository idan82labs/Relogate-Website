...
ובימי ו' וערבי חג בין השעות 8:00–13:00.`,
  ...
  reportResults: {
    ...
    reportSection: {
      title: "דו״ח Relomach",
      description:
        "הדו״ח האישי שלך מוכן! להלן {count} מדינות שהותאמו עבורך על בסיס הצרכים והיכולות שהגדרת. לכל מדינה מוצגים שם המסלול המומלץ, דירוג התאמה כללי ויתרונות מרכזיים במעבר.",
    },
  ...
  personalAreaDashboard: {
    ...
    sections: {
      ...
      personalizedReport: {
        ...
        notReady: "הדוח שלך בהכנה",
        notReadyDescription: "צוות Relogate עובד על הכנת הדוח האישי שלך. נעדכן אותך ברגע שהוא יהיה מוכן!",
        ready: "הדוח שלך מוכן!",
