      ...
      <div className="container">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/press"
              className="text-[#215388] hover:underline text-sm font-medium"
            >
              לכל הכתבות
            </Link>
        ...
        >
          {isLoading ? (
            ...
            Array.from({ length: 4 }).map((_, index) => (
              <div
                key={index}
                className="flex-none w-[280px] aspect-[4/5] rounded-[20px] bg-[#F7F7F7] animate-pulse"
              />
            ))
          ) : (
            posts.map((post, index) => (
              ...
              >
                <Link href={`/press/${post.slug}`}>
                  {/* Image */}
                  <div className="relative aspect-[4/5] rounded-[20px] overflow-hidden mb-4 group cursor-pointer">
